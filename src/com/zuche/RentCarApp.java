...
public class RentCarApp {
    ...
    public static void main(String[] args) {
        ...
        if (i == 1) {
            ...
            for(BaseCar car : CarsManager.getAllCars()){
                System.out.printf("Num.%d %s %dyuan  zaikeliang:%dren%n",car.no,car.name,car.price,car.size);
            }
